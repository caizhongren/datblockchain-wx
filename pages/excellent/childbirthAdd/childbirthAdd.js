...
Page({
  ...
  saveAddress(){
    ...
    if (data.pigletNumber != data.aliveNumber + data.mummyNumber + data.drowningNumber + data.stillbirthNumber) {
  ...
  TimeFormat(data) {
    if (data) {
        ...
        if (data.preproductionTime) {
          data.preproductionTime = data.preproductionTime.split("T")[0];
        } else {
